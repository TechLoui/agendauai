    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 font-sans">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 md:py-32">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-amber-100 dark:bg-amber-950/60 text-amber-700 dark:text-amber-300 text-sm font-medium px-4 py-1.5 rounded-full mb-6 border border-amber-200 dark:border-amber-800">
              <Zap size={14} />
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 dark:text-white leading-tight mb-6">
              Agendamentos online{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 via-emerald-500 to-amber-400">
                sem complicação
              </span>
            </h1>
      ...
      <footer className="border-t border-gray-100 dark:border-gray-800 py-8">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-400">
          <img src="/Logo (sem fundo).png" alt="Agenda Uai" className="h-7 w-auto" />
